...
def generate_thumbnails():
    ...
    for image_file in image_files:
        ...
        scaled_img.save(f"static/peptides/thumbs/{image_file}", optimize=True, quality=50)
...
def generate_docked_thumbnails():
    ...
    for image_file in image_files:
        ...
        scaled_img.save(f"static/peptides/docked/thumbs/{image_file}", optimize=True, quality=50)
        print(f"Thumb generated: {image_file}")
